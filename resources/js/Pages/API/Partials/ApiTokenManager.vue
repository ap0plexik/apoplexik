    ...
    <div>
        ...
        <FormSection @submitted="createApiToken">
            ...
            <template #actions>
                ...
                <ButtonPrimary :class="{ 'opacity-25': createApiTokenForm.processing }" :disabled="createApiTokenForm.processing">
                    Create
                </ButtonPrimary>
            </template>
        </FormSection>
        ...
        <DialogModal :show="displayingToken" @close="displayingToken = false">
            ...
            <template #footer>
                <Button @click="displayingToken = false">
                    Close
                </Button>
            </template>
        </DialogModal>
        ...
        <DialogModal :show="managingPermissionsFor != null" @close="managingPermissionsFor = null">
            ...
            <template #footer>
                <Button @click="managingPermissionsFor = null">
                    Cancel
                </Button>
